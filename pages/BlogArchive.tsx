...
const articles = [
  ...
  },
  {
    ...
    excerpt: "What determines the price of a high-end website? A transparent breakdown.",
    category: "Business",
    date: "Jan 10, 2026",
    readTime: "6 min read",
  ...
  },
  {
    ...
    title: "Automated Booking & Payments for salons and studios",
    excerpt: "How studios are using custom platforms to eliminate admin work.",
    category: "Solutions",
    date: "Jan 12, 2026",
    readTime: "8 min read",
  ...
  },
  {
    ...
    title: "Beyond Zoom: Building Platforms for Online Tutors",
    excerpt: "Scale your education brand with custom student portals and portals.",
    category: "Education",
    date: "Jan 15, 2026",
    readTime: "7 min read",
  ...
  },
  {
    ...
    title: "High-Performance Web Design: Why Quality Outperforms",
